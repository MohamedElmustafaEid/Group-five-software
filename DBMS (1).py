...
conn = connect("dbname=Mohamedelmusatafaeid user=Mustafaeidx host=localhost password=Mustafa_62")
cur = conn.cursor()
...
data_df['Interview_date'] = data_df['6_Interview_Date']
...
engine = create_engine('postgresql://Mustafaeidx:Mustafa_62@localhost:5432/Mohamedelmusatafaeid')
